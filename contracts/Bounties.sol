...
/**
 * @title Bounties
 * @dev Simple smart contract which allows any user to: issue, fulfill, accept, and cancel a Bounty
 */
...
contract Bounties {
  ...
  */
  function issueBounty(string calldata _data, uint64 _deadline)
      external
      payable
      hasValue()
  ...
  * @param _data answer to the bounty to be fulfilled 
  */
